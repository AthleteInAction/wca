angular.module('Event_userModule',['ApiModelV1Module'])
.service('Event_userSVC',['ApiModelV1','$timeout',function(ApiModelV1,$timeout){
	...
	this.event_users = {
		...
		nextPage: function(complete){
			...
			ApiModelV1.query(options,function(data){
				...
				angular.forEach(data.event_users,function(val,key){
		...
		find: function(id,complete){
			...
			ApiModelV1.get(options,function(data){
				...
				if (complete){complete(data.event_user,false);}
		...
		new: function(api_module){
			...
			api_module.update = function(field,value,complete){
				...
				var Item = new ApiModelV1({event_user: new_item});
				...
				Item.$save(options,function(data){
					...
					api_module.x876[field] = data.event_user[field];
					api_module[field] = data.event_user[field];
			...
			api_module.save = function(complete){
				...
				if (ID){
					...
					Item.$save(options,function(data){
						...
						angular.forEach(data.event_user,function(val,key){
