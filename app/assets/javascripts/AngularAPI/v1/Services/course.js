angular.module('CourseModule',['ApiModelV1Module'])
.service('CourseSVC',['ApiModelV1','$timeout',function(ApiModelV1,$timeout){
	...
	this.courses = {
		...
		nextPage: function(complete){
			...
			ApiModelV1.query(options,function(data){
				...
				angular.forEach(data.courses,function(val,key){
		...
		find: function(id,complete){
			...
			ApiModelV1.get(options,function(data){
				...
				if (complete){complete(data.course,false);}
		...
		new: function(api_module){
			...
			api_module.update = function(field,value,complete){
				...
				var Item = new ApiModelV1({course: new_item});
				...
				Item.$save(options,function(data){
					...
					api_module.x876[field] = data.course[field];
					api_module[field] = data.course[field];
			...
			api_module.save = function(complete){
				...
				if (ID){
					...
					Item.$save(options,function(data){
						...
						angular.forEach(data.course,function(val,key){
