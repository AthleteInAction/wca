angular.module('PlaylistModule',['ApiModelV1Module'])
.service('PlaylistSVC',['ApiModelV1','$timeout',function(ApiModelV1,$timeout){
	...
	this.playlists = {
		...
		nextPage: function(complete){
			...
			ApiModelV1.query(options,function(data){
				...
				angular.forEach(data.playlists,function(val,key){
		...
		find: function(id,complete){
			...
			ApiModelV1.get(options,function(data){
				...
				if (complete){complete(data.playlist,false);}
		...
		new: function(api_module){
			...
			api_module.update = function(field,value,complete){
				...
				var Item = new ApiModelV1({playlist: new_item});
				...
				Item.$save(options,function(data){
					...
					api_module.x876[field] = data.playlist[field];
					api_module[field] = data.playlist[field];
			...
			api_module.save = function(complete){
				...
				if (ID){
					...
					Item.$save(options,function(data){
						...
						angular.forEach(data.playlist,function(val,key){
