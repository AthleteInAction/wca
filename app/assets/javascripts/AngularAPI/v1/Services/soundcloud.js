angular.module('SoundcloudModule',['ApiModelV1Module'])
.service('SoundcloudSVC',['ApiModelV1','$timeout',function(ApiModelV1,$timeout){
	...
	this.soundclouds = {
		...
		nextPage: function(complete){
			...
			ApiModelV1.query(options,function(data){
				...
				angular.forEach(data.soundclouds,function(val,key){
		...
		find: function(id,complete){
			...
			ApiModelV1.get(options,function(data){
				...
				if (complete){complete(data.soundcloud,false);}
		...
		new: function(api_module){
			...
			api_module.update = function(field,value,complete){
				...
				var Item = new ApiModelV1({soundcloud: new_item});
				...
				Item.$save(options,function(data){
					...
					api_module.x876[field] = data.soundcloud[field];
					api_module[field] = data.soundcloud[field];
			...
			api_module.save = function(complete){
				...
				if (ID){
					...
					Item.$save(options,function(data){
						...
						angular.forEach(data.soundcloud,function(val,key){
